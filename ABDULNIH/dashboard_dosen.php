...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul>
        <li><a href="input_nilai.php"><i class="fas fa-users"></i> Input Nilai</a></li>            
        <li><a href="statistics_dosen.php"><i class="fas fa-chart-line"></i> Lihat Statistik</a></li>
        <li><a href="absensi_mahasiswa.php"><i class="fas fa-file-alt"></i> Absen Mahasiswa</a></li>
        </ul>
        <ul>
    ...
    <div class="content">
        ...
        <p>Di sini Anda bisa menginput nilai, absensi, dan melihat statistik.</p>
    </div>
