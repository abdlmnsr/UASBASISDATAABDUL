...
<body>
    ...
    <div id="sidebar" class="sidebar">
        <h2>Dashboard</h2>
        <ul>
            <li><a href="menu.php"><i class="fas fa-play"></i> Mulai Ujian</a></li>
            <li><a href="schedule.php"><i class="fas fa-calendar-alt"></i> Jadwal Ujian</a></li>
            <li><a href="about.php"><i class="fas fa-info-circle"></i> Tentang</a></li>
            <li><a href="peraturan.php"><i class="fas fa-cog"></i> Peraturan</a></li>
        </ul>
        <ul>
    ...
    <!-- Bagian Konten -->
    <div class="content">
        <h1>SELAMAT DATANG DI APLIKASI UJIAN ONLINE</h1>
    ...
    <script>
        ...
        // Menutup sidebar jika pengguna klik di luar sidebar
